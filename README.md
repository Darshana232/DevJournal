DevJournal — AI-Powered Developer Journal
 ...
 A production-level React journaling application built for developers who want to reflect, grow, and track their progress — powered by Anthropic Claude AI.
...
- Get **AI-generated reflections** (via Claude) that surface patterns in thinking
...
AI Insights Claude-powered reflection, suggestion, and thought-provoking question per entry 
...
Tags & Moods Predefined + custom tags, 5-mood picker, and multi-filter search 
...
Weekly AI Digest Summarize your recent week's entries into a single paragraph with Claude 
...
├── services/        # aiService (Claude API), analyticsService (LocalStorage stats)
